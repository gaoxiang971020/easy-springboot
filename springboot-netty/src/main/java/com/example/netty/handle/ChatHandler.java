...
import com.example.netty.websocket.UserChannelRel;
import com.example.netty.bean.ChatMsg;
import com.example.netty.bean.DataContent;
import com.example.netty.enums.MsgActionEnum;
...
public class ChatHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, TextWebSocketFrame msg)
        ...
        if (action.equals(MsgActionEnum.CONNECT.type)) {
            ...
            Integer receiverId = chatMsg.getAcceptUserId();
            Integer senderId = chatMsg.getSendUserId();
